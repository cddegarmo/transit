package main;/* This is my solution for the "Transit Calculator" challenge. It's a program that evaluates which fare option will
result in the least expensive per-ride cost based on how many days and rides one plans to take on vacation.
 */

// Utility class, designed simply to facilitate invoking of getBestFare()
public class TransitCalculator {
    private static int days;
    private static int rides;
    private static final String[] FARES = {
         "Pay-per-ride",
         "7-day Unlimited",
         "30-day Unlimited"
    };
    ...
    public static String getBestFare(int days, int rides) {
        if (days <= 0 || rides <= 0)
            return "Minimum of 1 day and 1 ride for program to run.";
